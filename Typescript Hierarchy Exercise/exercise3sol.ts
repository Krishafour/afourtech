...

{
    ...
    //adding types of member and return type
  ...
  /*
    ...
    const bankAccount = {
        money:0,
        //adding types and make message as optional parameter
      ...
      bankAccount.deposit(20);//calling using one variable only
      bankAccount.deposit(10, 'Deposit received')
 ...
 /*   function computeScore(word) {
    ...
    */
   //adding types to the parameter and return type
    ...
    function greet(greeting:string):string {
      ...
      const defaultGreeting = greet('hallo');//calling using parameter
      const portugueseGreeting = greet('Oi como vai!');
  ...
  //adding types to the parameter and return type
    ...
    layEggs(104,'yellow');//adding parameter
   ...
   /* let multiply: (val1: number, val2: number) => number;
    ...
    //changing the parameter and return type of function
   let multiply: (val1: number, val2: number) => number;
    let capitalize: (val: string) => string;
